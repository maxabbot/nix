...
{ config, lib, pkgs, ... }:
{
  ...
  programs.starship = {
    ...
    settings = {
      ...
      os       = { disabled = false; style = "bg:#282828 fg:#d3869b"; };
      username = {
        show_always = true;
      ...
      python = { symbol = ""; style = "bg:#665c54 fg:#d8a657"; format = "[ $symbol ($version) ]($style)"; };
      nodejs = { symbol = ""; style = "bg:#665c54 fg:#a9b665"; format = "[ $symbol ($version) ]($style)"; };
      rust   = { symbol = ""; style = "bg:#665c54 fg:#e78a4e"; format = "[ $symbol ($version) ]($style)"; };
      golang = { symbol = ""; style = "bg:#665c54 fg:#89b482"; format = "[ $symbol ($version) ]($style)"; };
      java   = { symbol = ""; style = "bg:#665c54 fg:#ea6962"; format = "[ $symbol ($version) ]($style)"; };
      time = {
        disabled    = false;
        time_format = "%H:%M";
