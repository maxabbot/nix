  ...
  config = lib.mkIf isWayland {
    programs.waybar = {
      ...
      settings = [{
        ...
        "modules-left"   = [ wsModule winModule ];
        "modules-center" = [ "clock" ];
        "modules-right"  = [
          "tray" "idle_inhibitor" "pulseaudio"
      ...
      style = ''
        * {
        ...
        #network, #pulseaudio, #tray, #idle_inhibitor {
          padding: 0 10px;
          margin: 5px 0px;
          background: #3c3836;
          border-radius: 8px;
        ...
        #clock         { color: #d8a657; font-weight: bold; }
        #battery       { color: #a9b665; }
        #battery.charging { color: #a9b665; }
        #battery.warning:not(.charging) { color: #d8a657; }
        ...
        #cpu           { color: #d3869b; }
        #memory        { color: #7daea3; }
        #temperature   { color: #e78a4e; }
        #temperature.critical {
          color: #ea6962;
          animation: blink 1s linear infinite;
        }
        #network           { color: #89b482; }
        #network.disconnected { color: #ea6962; }
        #pulseaudio        { color: #d8a657; }
        #pulseaudio.muted  { color: #7c6f64; }
        #tray              { background: transparent; }
        #tray > .passive   { -gtk-icon-effect: dim; }
        #tray > .needs-attention { -gtk-icon-effect: highlight; }
        #idle_inhibitor    { color: #d4be98; }
        #idle_inhibitor.activated { color: #a9b665; }

        @keyframes blink { to { color: #282828; } }
