...
# Mirrors kitty.conf, btop config, and related Chezmoi configs.
{ pkgs, ... }:
{
  # ── Kitty terminal ─────────────────────────────────────────────────────────────
  programs.kitty = {
    ...
    settings = {
      ...
      color0  = "#3c3836"; color8  = "#928374";
      color1  = "#ea6962"; color9  = "#ea6962";
      color2  = "#a9b665"; color10 = "#a9b665";
      color3  = "#d8a657"; color11 = "#d8a657";
  ...
  xdg.configFile."swaync/config.json".source =
    ../../user/dot_config/swaync/config.json;
  xdg.configFile."swaync/style.css".source =
    ../../user/dot_config/swaync/style.css;

  # ── Wlogout logout screen ─────────────────────────────────────────────────────
  xdg.configFile."wlogout/layout".source =
    ../../user/dot_config/wlogout/layout;
  xdg.configFile."wlogout/style.css".source =
    ../../user/dot_config/wlogout/style.css;

  # ── Fastfetch system info ─────────────────────────────────────────────────────
  xdg.configFile."fastfetch/config.jsonc".source =
    ../../user/dot_config/fastfetch/config.jsonc;

  # ── Mise version manager ──────────────────────────────────────────────────────
  home.packages = [ pkgs.mise ];
  xdg.configFile."mise/config.toml".source =
    ../../user/dot_config/mise/config.toml;
}
