...
#
# wallpaper opens each shell's own picker like everything else. Both
# third-party shells hand their picks to awww (noctalia-wallpaper-hook.sh,
# dms-wallpaper-bridge.sh), so awww stays the only wallpaper layer.
#
