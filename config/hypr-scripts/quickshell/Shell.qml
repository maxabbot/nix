...
ShellRoot {
    ...
    readonly property var settingsTabs: ["control", "network", "bluetooth", "kdeconnect", "audio", "monitors", "wallpaper", "keyboard", "input", "battery", "disks", "sysinfo", "nix"]
    ...
    WorkspaceOverview {
        visible: root.activePanel === "overview"
        onCloseRequested: root.activePanel = ""
    }
